...
class SearchDialogWithSingleSelect extends StatefulWidget {
  List<CheckDialogBox> teacherData;
  String title;
  Function(String id, String name) onTeacherSelected;
  bool isAll;

  SearchDialogWithSingleSelect(
      this.teacherData, this.title, this.onTeacherSelected,
      {this.isAll = false, super.key});

  @override
  State<SearchDialogWithSingleSelect> createState() =>
      _SearchDialogWithSingleSelectState();
}

class _SearchDialogWithSingleSelectState
    extends State<SearchDialogWithSingleSelect> {
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              widget.onTeacherSelected(data.id, data.title);
                              Navigator.pop(context);
                            },
                            child: Container(
                              child: Column(
