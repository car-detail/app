...
class ViewOfferListViaDetail extends StatefulWidget {
  ...
  ViewOfferListViaDetail(this.servicesDetailsData, {super.key});

  @override
  State<ViewOfferListViaDetail> createState() => _ViewOfferListViaDetailState();
}

class _ViewOfferListViaDetailState extends State<ViewOfferListViaDetail> {
  ...
  getCategory(BuildContext context) async {
    var response = await servicesDataManager!.getOfferByServiceId(
        context, widget.servicesDetailsData.sId.toString());
